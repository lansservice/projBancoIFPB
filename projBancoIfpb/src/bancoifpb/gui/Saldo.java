...
public class Saldo extends JPanel {
    ...
    public Saldo() {
        ...
        setPreferredSize (new Dimension(399, 117));
        setLayout (null);
        ...
        txt_cliente.setBounds (5, 65, 384, 39);
    ...
    private void PesquisarSaldoConta() {
    	...
    	if (Sistema.banco.getMap_agencia().containsKey(txt_agencia.getText()) == true){
    		if (Sistema.banco.getAgenciaMapa(txt_agencia.getText()).getMap_conta().containsKey(txt_conta.getText()) == true) {
    			...
    			dados_conta = "Saldo: " + conta.getValorSaldo();
    ...
    private void Sair(){
    	Sistema.frm_saldo.getContentPane().removeAll();
